...
impl SerializableToken<'_, '_> {
  #[must_use]
  pub(crate) const fn punctuator(span: oxc_span::Span, value: &'static str) -> Self {
    Self::Synthetic(VToken::new(crate::lexer::VTokenKind::Punctuator, span, value))
  }

  #[must_use]
  pub(crate) const fn script_tag(span: oxc_span::Span) -> Self {
    Self::punctuator(span, "<script>")
  }

  #[must_use]
  pub(crate) const fn script_end_tag(span: oxc_span::Span) -> Self {
    Self::punctuator(span, "</script>")
  }
}
